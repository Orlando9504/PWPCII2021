...
// import winston, { format } from 'winston';
// import appRoot from 'app-root-path';
// // componente para crear el formato personalizado
// const { combine, timestamp, printf, json, colorize, uncolorize } = format;
// //
// // Creand el perfil de color para el log
// const colors = {
//   error: 'red',
//   warn: 'yellow',
//   info: 'green',
...
//     filename: `${appRoot}/server/logs/errors.log`,
//     handleExceptions: true,
//     maxsize: 5242880, // 5 megas el tamaño
//     maxFiles: 5,
//     format: myFileFormat,
//   },
//   console: {
